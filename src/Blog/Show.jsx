            ...
            <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                ...
                {blog && (
                    <div>
                        ...
                        <div className="mx-auto grid max-w-2xl gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:items-start">
                            ...
                            <div className="lg:col-start-1 lg:mx-auto lg:grid lg:max-w-7xl lg:gap-x-8 lg:px-8">
                                <div className="lg:pr-4">
