        ...
        setTimeout(() => {
            fetch(`http://localhost:8000/blogs/${params.id}`)
                .then((resp) => {
                    if (!resp.ok) {
                        setIsPending(false);
                        throw Error('An error has occurred when loading the blog.');
                    }
                    return resp.json();
                })
                .then((data) => {
        ...
        <>
            ...
            <div className="bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Update blog</h2>
                    <p className="mt-2 text-lg leading-8 text-gray-600">
                        Fill the following form for updating the blog post.
                    </p>
                </div>
